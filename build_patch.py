...
# 2. Locate tools
javac_bin = shutil.which('javac') or r'C:\Program Files\JDownloader\jre\bin\javac.exe'
java_bin = shutil.which('java') or r'C:\Program Files\JDownloader\jre\bin\java.exe'
...
build_dir = os.path.join(repo_dir, 'build_work')
