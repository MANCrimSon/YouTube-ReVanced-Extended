...
CLI: MorpheApp/morphe-desktop-1.15.0-dev.6-all.jar  
Patches: MorpheApp/patches-1.41.0.mpp  
[Changelog](https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0)

Patches: sashade8-ship-it/patches-1.41.0-dualvot.8.3.mpp  
[Changelog](https://github.com/sashade8-ship-it/dual-vot-patches/releases/tag/v1.41.0-dualvot.8.3)  

Skipped:  
YouTube-Extended: already up to date
YouTube-Morphe: already up to date
