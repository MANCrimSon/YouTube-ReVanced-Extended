...
### On Termux
```console
bash <(curl -sSf https://raw.githubusercontent.com/MANCrimSon/revanced-magisk-module/main/build-termux.sh)
```

### On Desktop
```console
$ git clone https://github.com/MANCrimSon/revanced-magisk-module
