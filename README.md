...
rebuilt automatically as soon as new patches are released. Supports seamless **In-App Updates** and one-tap **Obtainium** auto-update profiles.

<!--release--><a href="../../releases/latest"><img src="https://img.shields.io/badge/release-v430-blue" alt="Latest release"></a><!--/release--> <!--downloads--><a href="../../releases"><img src="https://img.shields.io/badge/downloads-492.8k-success" alt="Downloads"></a><!--/downloads-->
...
* **Via Obtainium (Auto-updates):**  
  Install [**Obtainium**](https://github.com/ImranR98/Obtainium) and tap the **[Import]** links in the main Download table above to add automatic update profiles directly on your Android device.
